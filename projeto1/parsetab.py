...
_lr_action_items = {
    ...
    "$end": ([1, 2, 3, 4, 5, 11, 26, 36, 161,], [0, -2, -3, -5, -6, -4, -83, -7, -97,]),
    "TIMES": (
        [
            6,
            7,
...
_lr_goto_items = {
    ...
    "declaration": ([0, 2, 12, 23, 37, 167,], [5, 5, 25, 60, 25, 183,]),
    "type_specifier": (
        [0, 2, 12, 23, 30, 37, 51, 111, 167,],
        [6, 6, 20, 20, 72, 20, 106, 72, 20,],
    ),
    "declarator": ([6, 19, 20, 27, 72,], [12, 34, 35, 35, 114,]),
    "init_declarator_list": ([6, 20,], [13, 13,]),
    "pointer": ([6, 17, 19, 20, 27, 72,], [14, 32, 14, 14, 14, 14,]),
    "direct_declarator": ([6, 14, 19, 20, 27, 72,], [15, 28, 15, 15, 15, 15,]),
    "init_declarator": ([6, 20, 27,], [16, 16, 61,]),
    "declaration_list_opt": ([12, 37,], [21, 75,]),
    "declaration_list": ([12, 37,], [23, 23,]),
    "empty": (
        [
            12,
            17,
    ...
    "pointer_opt": ([17,], [31,]),
    "compound_statement": (
        [21, 75, 116, 189, 190, 201, 206, 207,],
        [36, 120, 120, 120, 120, 120, 120, 120,],
    ),
    "initializer": ([22, 40, 138,], [38, 77, 174,]),
    ...
    "constant_expression_opt": ([29,], [62,]),
    "constant_expression": ([29,], [63,]),
    "parameter_list": ([30,], [67,]),
    "identifier_list_opt": ([30,], [68,]),
    "parameter_declaration": ([30, 111,], [69, 160,]),
    "identifier_list": ([30,], [70,]),
    "initializer_list": ([40,], [76,]),
    "assignment_operator": ([42,], [91,]),
    "expression": (
        [
            51,
            75,
    ...
    "statement_list_opt": ([75,], [115,]),
    "statement_list": ([75,], [116,]),
    "statement": (
        [75, 116, 189, 190, 201, 206, 207,],
        [118, 162, 195, 196, 204, 208, 209,],
    ),
    ...
    "expression_opt": (
        [75, 116, 133, 167, 171, 183, 189, 190, 191, 198, 201, 202, 206, 207,],
        [127, 127, 169, 182, 186, 192, 127, 127, 197, 203, 127, 205, 127, 127,],
    ),
    "argument_expression": ([99, 172,], [154, 187,]),
}
...
_lr_productions = [
    ...
    ("constant -> ICONST", "constant", 1, "p_constant", "parser.py", 210),
    ("constant -> FCONST", "constant", 1, "p_constant", "parser.py", 211),
    (
        "expression -> assignment_expression",
        "expression",
        1,
    ...
    ("statement -> jump_statement", "statement", 1, "p_statement", "parser.py", 334),
    ("statement -> assert_statement", "statement", 1, "p_statement", "parser.py", 335),
    ("statement -> print_statement", "statement", 1, "p_statement", "parser.py", 336),
    ("statement -> read_statement", "statement", 1, "p_statement", "parser.py", 337),
    (
        "expression_statement -> expression_opt SEMI",
        "expression_statement",
        2,
