...
assigments = ('ASSIGN', 'TASSIGN', 'DASSIGN',
              'MODASSIGN', 'PASSIGN', 'MINASSIGN')

others = ('ID',
          'LPAREN','RPAREN',
          'RBRACE', 'LBRACE',
          'RBRACK', 'LBRACK', 'SEMI', 'ERROR', 'CCOMMENT', 'CPPCOMMENT')
...
from ply import lex
lexer = lex.lex()
lexer.input("/* comment */ int j = 3; int main () {  int i = j;int k = 3;int p = 2 * j; assert p == 2 * i;}")
