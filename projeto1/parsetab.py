...
_lr_productions = [
    ...
    ("empty -> <empty>", "empty", 0, "p_empty", "ucparser.py", 26),
    (
    ...
    ("pointer -> TIMES pointer_opt", "pointer", 2, "p_pointer", "ucparser.py", 73),
    ("pointer_opt -> pointer", "pointer_opt", 1, "p_pointer_opt", "ucparser.py", 78),
    ("pointer_opt -> empty", "pointer_opt", 1, "p_pointer_opt", "ucparser.py", 79),
    (
        "direct_declarator -> identifier",
        "direct_declarator",
        1,
    ...
    ("identifier -> ID", "identifier", 1, "p_identifier", "ucparser.py", 118),
    (
    ...
    ("expr -> cast_expression", "expr", 1, "p_expr", "ucparser.py", 135),
    ("expr -> expr PLUS expr", "expr", 3, "p_expr", "ucparser.py", 136),
    ("expr -> expr MINUS expr", "expr", 3, "p_expr", "ucparser.py", 137),
    ("expr -> expr TIMES expr", "expr", 3, "p_expr", "ucparser.py", 138),
    ("expr -> expr DIVIDE expr", "expr", 3, "p_expr", "ucparser.py", 139),
    ("expr -> expr EQUALS expr", "expr", 3, "p_expr", "ucparser.py", 140),
    ("expr -> expr MOD expr", "expr", 3, "p_expr", "ucparser.py", 141),
    ("expr -> expr GT expr", "expr", 3, "p_expr", "ucparser.py", 142),
    ("expr -> expr GET expr", "expr", 3, "p_expr", "ucparser.py", 143),
    ("expr -> expr LT expr", "expr", 3, "p_expr", "ucparser.py", 144),
    ("expr -> expr LET expr", "expr", 3, "p_expr", "ucparser.py", 145),
    ("expr -> expr DIFF expr", "expr", 3, "p_expr", "ucparser.py", 146),
    ("expr -> expr AND expr", "expr", 3, "p_expr", "ucparser.py", 147),
    ("expr -> expr OR expr", "expr", 3, "p_expr", "ucparser.py", 148),
    (
        "cast_expression -> unary_expression",
        "cast_expression",
        1,
    ...
    ("constant -> ICONST", "constant", 1, "p_constant_1", "ucparser.py", 237),
    ("constant -> FCONST", "constant", 1, "p_constant_2", "ucparser.py", 242),
    (
        "expression -> assignment_expression",
        "expression",
        1,
    ...
    ("statement -> jump_statement", "statement", 1, "p_statement", "ucparser.py", 382),
    (
    ...
    ("statement -> print_statement", "statement", 1, "p_statement", "ucparser.py", 384),
    ("statement -> read_statement", "statement", 1, "p_statement", "ucparser.py", 385),
    (
        "expression_statement -> expression_opt SEMI",
        "expression_statement",
        2,
